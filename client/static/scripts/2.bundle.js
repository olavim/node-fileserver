...
/***/ function(module, exports, __webpack_require__) {
	...
	var btoa = window.btoa || __webpack_require__(236);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _FileList = __webpack_require__(247);
	...
	module.exports = _react2.default.createClass({
	    ...
	    render: function render() {
	        return _react2.default.createElement(
	            ...
	            _react2.default.createElement(_FileList2.default, { files: this.state.files, path: this.state.path })
	        );
	    }
	});
	    ...
	    render: function render() {
	        ...
	        var fileComponents = files.map(function (file, index) {
	            if (file.type === 'directory') {
	                var p = path.join(path, file.name);
	                return _react2.default.createElement(
	                    'li',
	                    { key: index },
	                    _react2.default.createElement(
